...
$style = [
    ...
    'email-body' => 'width: 100%; margin: 0; padding: 0; border-top: 0px solid #EDEFF2; border-bottom: 0px solid #EDEFF2; background-color: #212121;',
    ...
    'stripes' => 'height: 10px;background: repeating-linear-gradient(45deg,#1c30e9,#1c30e9 8px,#ffffff 10px,#ffffff 15px);max-width: 570px;margin: auto;margin-bottom: -18px;border-radius: 3px;',
];
?>
                    ...
                    <tr>
                        <td style="{{ $style['email-masthead'] }}">
                            ...
                            <div style="display: flex;align-items: center;">
                                <h1 style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}">OverTimeHosting</h1>
